...
# usage python -m train.pga_aurora_trainer --config-name pga_aurora.yaml env=brax/ant_maze
@hydra.main(config_path="../configs", config_name="pga_aurora.yaml", version_base=None)
def main(cfg: DictConfig) -> None:
    ...
    with wandb.init(config=wandb_cfg, **cfg.wandb):
        ...
        centroids, random_key = compute_cvt_centroids(
            ...
            minval=env.behavior_descriptor_limits[0],
            maxval=env.behavior_descriptor_limits[1],
            random_key=subkey,
        )
