...
class GARepertoire(Repertoire):
    ...
    def add(
        ...
        # sort by fitnesses
        indices = jnp.argsort(candidates_fitnesses)[::-1]
        ...
        return new_repertoire, survivor_indices  # type: ignore
    ...
    def init(  # type: ignore
        ...
        default_fitnesses = -jnp.inf * jnp.ones(shape=(population_size,))
        ...
        new_repertoire, survivor_indices = repertoire.add(genotypes, fitnesses)
