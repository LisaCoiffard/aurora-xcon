...
from qdax.tasks.environments_v1.exploration_wrappers import MazeWrapper, TrapWrapper
from qdax.tasks.environments_v1.humanoidtrap import HumanoidTrap
...
from qdax.tasks.environments_v1.locomotion_wrappers import (
    ...
    PassiveStandingWrapper,
    StandDescWrapper,
    XYPositionFeetInfoWrapper,
    XYPositionWrapper,
)
from qdax.tasks.environments_v1.pointmaze import PointMaze
from qdax.tasks.environments_v1.wrappers import CompletedEvalWrapper
...
behavior_descriptor_extractor = {
    ...
    "ant_maze": get_final_xy_position,
...
_qdax_custom_envs = {
    ...
    "ant_unip": {
        "env": "ant",
        "wrappers": [FeetContactWrapper, PassiveStandingWrapper],
        "kwargs": [{}, {}],
    },
    "ant_omnip": {
        "env": "ant",
        "wrappers": [XYPositionFeetInfoWrapper, PassiveStandingWrapper],
        "kwargs": [
            {"minval": [-30.0, -30.0], "maxval": [30.0, 30.0]},
            {},
        ],
    },
    "ant_uni_stand": {
    ...
    "ant_stand": {
        "env": "ant",
        "wrappers": [StandDescWrapper, PassiveStandingWrapper],
        "kwargs": [
            {"minval": [0.3, 0.0], "maxval": [4.0, 1.57]},
            {},
        ],
    },
}
