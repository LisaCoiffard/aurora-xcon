...
import qdax.tasks.environments
...
def create_default_brax_task_components(
    ...
    bd_extraction_fn = qdax.tasks.environments.behavior_descriptor_extractor[env_name]
...
def get_aurora_scoring_fn(
    ...
    def _wrapper(
        ...
        data = (extra_scores["transitions"], extra_scores["final_state"])
        observation = observation_extractor_fn(data)  # type: ignore
        extra_scores["observations"] = observation
        return fitnesses, descriptors, extra_scores, random_key
